...
function AgregarEspecialidad(grado,especialidad){
    ...
    {grado:grado, especialidad:especialidad}, function(e){
...
function seleccionar(){  var e = new Option("SELECCIONAR", 0);
...
$.post("../Controlador/perfil_docente_controlador.php?op=MostrarEspecialidad",{},
...
function Actividades(){
    ...
    $.post("../Controlador/perfil_docente_controlador.php?op=Actividades",{}, function(data, status){
