...
if (isset($_GET['alumno'])){
    ...
    $sqltabla = json_decode( file_get_contents("http://34.203.186.135/Automatizacion/api/cancelar_clases.php?alumno=".$_GET['alumno']), true );
    bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'],'INGRESO' , 'A REVISION CANCELAR CLASES ALUMNO '.$sqltabla["ROWS"][0]['nombre'].'');
}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<?php echo $sqltabla["ROWS"][0]['cuenta'] ?>" type="text" id="txt_cuenta" name="txt_cuenta1" style="text-transform: uppercase" onkeypress="return Letras(event)" onkeyup="DobleEspacio(this, event)" readonly onmousedown="return false;">
                        </div>
                </div>
                <div class="col-md-6">
                        <div class="form-group">
