...
$sql_tabla_empresa = json_decode( file_get_contents('http://informaticaunah.com/home/informaticaunah/public_html/automatizacion/api/empresas_practica_api.php?id_persona='.$id_persona), true );
