        ...
        <div class="container-fluid">
            ...
            <div class="card-body" style="display: block;">
              <div class="row" >
                ...
                <div class="col-sm-12" style= "text-align: center">
                  ...
                  <!--FOTOGRAFIA -->
                  <!-- <label>Foto</label> -->
                  <img src="../Imagenes_Perfil_Docente/default-avatar.png" class="brand-image img-circle elevation-3"  id="mostrarimagen" height="175"
                                width="175" >
                  <input class= "form-control-file" type="file" accept="image/x-png,image/gif,image/jpeg"   id="seleccionararchivo" name="seleccionararchivo" maxlength="8388608" required><br><br>
          ...
          <!-- /.card-body -->
            <p class="text-center" style="margin-top: 10px;">
              <button type="submit" class="btn btn-primary btn-lg"  id="btn_guardar_registro_docentes" name="btn_guardar_registro_docentes" 
               onclick="RegistarDocente($('#txt_nombres').val(), $('#txt_apellidos').val(), $('#cb_genero').val(), $('#identidad').val(), $('#cb_nacionalidad').val(), $('#cb_ecivil').val(), $('#txt_fecha_nacimiento').val(), $('#txt_hi').val(), $('#txt_hf').val(), $('#txt_n_empleado').val(), $('#txt_fecha_ingreso').val());   ">
