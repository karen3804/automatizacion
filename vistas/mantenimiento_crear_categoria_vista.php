                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="../vistas/mantenimiento_categoria_vista.php"> Mantenimiento Categoría</a></li>
                        </ol>
                    </div>
                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="form-group ">
                                        ...
                                        <input class="form-control " type="text" id="txt_categoria1" name="txt_categoria1" required="" maxlength="30" style="text-transform: uppercase" onkeypress="return LetrasNumeros(event)" onkeypress="DobleEspacio(this, event)" onkeypress="return comprobar(this.value, event, this.id)">
                                    </div>
